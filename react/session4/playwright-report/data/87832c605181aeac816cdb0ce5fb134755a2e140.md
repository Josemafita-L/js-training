...
- Name: intern-dashboard.spec.ts >> Locator Practice — getByRole >> finds the score input by placeholder
- Location: tests\intern-dashboard.spec.ts:105:3
...
Locator: getByPlaceholder('Score')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByPlaceholder('Score')
