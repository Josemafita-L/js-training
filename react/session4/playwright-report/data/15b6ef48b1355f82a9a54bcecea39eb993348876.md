...
- Name: intern-dashboard.spec.ts >> Locator Practice — getByRole >> finds text with regex matching
- Location: tests\intern-dashboard.spec.ts:119:3
...
Locator: getByText(/Score: \d+/).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Score: \d+/).first()
