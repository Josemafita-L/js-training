...
- Name: intern-dashboard.spec.ts >> Locator Practice — getByRole >> finds the name input by placeholder
- Location: tests\intern-dashboard.spec.ts:97:3
...
Locator: getByPlaceholder('Intern Name')
Expected: visible
Timeout: 5000ms
