...
- Name: locators-actions.spec.ts >> fills the form using scoped locators
- Location: tests\locators-actions.spec.ts:82:1
...
Call log:
  - waiting for getByTestId('add-intern-form').getByPlaceholder('Intern Name')
