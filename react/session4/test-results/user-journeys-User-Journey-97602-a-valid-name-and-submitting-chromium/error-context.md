...
- Name: user-journeys.spec.ts >> User Journey - Add Intern Validation >> error clears after entering a valid name and submitting
- Location: tests\user-journeys.spec.ts:102:3
