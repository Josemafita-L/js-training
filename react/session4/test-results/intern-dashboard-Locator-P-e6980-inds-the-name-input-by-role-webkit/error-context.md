...
- Name: intern-dashboard.spec.ts >> Locator Practice — getByRole >> finds the name input by role
- Location: tests\intern-dashboard.spec.ts:88:3
...
Locator: getByRole('textbox', { name: 'Intern Name' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('textbox', { name: 'Intern Name' })
