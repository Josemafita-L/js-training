...
- Name: intern-dashboard.spec.ts >> Locator Practice — getByRole >> finds the Add Intern button by role
- Location: tests\intern-dashboard.spec.ts:70:3
...
Locator: getByRole('button', { name: 'Add Intern' })
Expected: visible
Timeout: 5000ms
