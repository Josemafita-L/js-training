...
- Name: user-journeys.spec.ts >> User Journey - Add Intern >> user fills the form and the new intern appears in the list
- Location: tests\user-journeys.spec.ts:14:3
